  ...
  return (
    <div
      className={`
        ...
        rounded-3xl border border-white/20 shadow-2xl p-3 sm:p-6 md:p-8 text-center 
        transition-all duration-[1500ms] ease-out transform
        max-h-[100dvh] flex flex-col justify-between overflow-y-auto
    ...
    >
      <div className="flex-1 flex flex-col justify-start">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-playfair text-white mt-0 mb-1 animate-glow">
          Happy Holidays <span className="text-base sm:text-2xl md:text-3xl text-red-400 block sm:inline">- Peace & Love Aunt Buttah</span>
        </h1>

        {/* Names List */}
        <div className="text-xs sm:text-sm md:text-base tracking-[0.2em] text-white/80 uppercase mb-2">
          Jenna • Alonna • Arionna • Amiyah
        </div>

        {/* Animated Visual (Tropical) */}
        <div className="mb-2 overflow-hidden rounded-xl shadow-lg border border-white/10 relative h-32 sm:h-56 md:h-72">
          <img
        ...
        <div
          ...
          `}
        >
          <p className="text-base sm:text-lg md:text-xl text-white mb-2 leading-snug font-light italic">
            This season comes with sunshine, room keys,
            and lots of fun and adventure.
          </p>

          <div className="bg-white/15 p-2 sm:p-5 rounded-2xl mb-2 border border-white/20 shadow-xl scale-100 hover:scale-[1.02] transition-transform">
          ...
          <div className="text-sm sm:text-base md:text-lg text-white/90 mb-2 bg-black/20 py-1.5 rounded-full inline-block px-4">
      ...
      {/* Footer Message */}
      <footer className="mt-1 pt-2 border-t border-white/10 text-xs sm:text-sm text-white/50 leading-tight italic">
